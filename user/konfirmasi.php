...
if (isset($_POST["submit"]) ) {
  ...
  if ( tambahkonfirmasi ($_POST) > 0 ) {
    echo "<script>
      alert('pembayaran anda akan dikonfirmasi!');
...
<body>
  ...
  <form id="contact" action="" method="post" enctype="multipart/form-data">
    <h3><center>Form Konfirmasi Pembayaran</center></h3>
    ...
    <fieldset>
      <label for="nm_pendaftar">Nama Pendaftar</label>
      <input type="text" name="nm_pendaftar" id="nm_pendaftar" required autofocus maxlength="30"/>
    </fieldset> 
    <fieldset>
      <label for="foto_bukti">Foto</label>
      <input type="file" name="foto_bukti" id="foto_bukti" required autofocus>
    </fieldset>
    <fieldset>
      <button name="submit" type="submit" id="contact-submit" data-submit="...Sending">Konfirmasi</button>   
    </fieldset>
  </form>
</div>
