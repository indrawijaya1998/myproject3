...
<html lang="en">
<head>
	<title>PMB STIH DAMARICA PALOPO</title>
	<meta charset="UTF-8">
	<meta name="description" content="PMB STIH DAMARICA PALOPO">
...
<body>
		...
		<div class="container">
			...
			<div class="header-info">
				<div class="hf-item">
					...
					<p><span>Waktu Kerja:</span>Senin - Jumat: 10.00 - 17.00 </p>
				</div>
				<div class="hf-item">
					<i class="fa fa-map-marker"></i>
					<p><span>Alamat Kami:</span>Jln. DR. Ratulangi KM.3 No.08 Bukit Balandai FAX (0471) 22303, Kota Palopo</p>
				</div>
			</div>
		</div>
	</header>
	...
	<section class="hero-section">
		<div class="hero-slider owl-carousel">
			<div class="hs-item set-bg" data-setbg="img/stih.jpg">
				<div class="hs-text">
					<div class="container">
						<div class="row">
							<div class="col-lg-8">
			...
			<div class="hs-item set-bg" data-setbg="img/stih1.jpg">
				<div class="hs-text">
					<div class="container">
						<div class="row">
							<div class="col-lg-8">
